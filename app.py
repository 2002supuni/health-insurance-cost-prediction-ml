...
import numpy as np
import joblib
scaler = joblib.load(r"C:\path\to\your\scaler.pkl")
...
st.write("Enter the details below estimate your insurance payment amount:")
...
with st.form("prediction_form"):
  ...
  with col2:
    ...
    bloodpressure = st.selectbox("Blood Pressure",min_value = 60,max_value=200,value=120 )
...
st.success(f"The estimated payment amount is {prediction:,.2f}")
